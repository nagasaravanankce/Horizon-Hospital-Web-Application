...
import './LandingDoctorsStyle.css'; 
import { Link } from "react-router-dom";

const Doctors = () => {
  const doctors = [
    { name: "Dr. Peter Parker", specialty: "Neurologist", image: "./Assets/1000_F_260040900_oO6YW1sHTnKxby4GcjCvtypUCWjnQRg5.jpg" },
        ...
        <nav>
          <ul>
            <li><Link to="/HorizonHospital">Home</Link></li>
                        <li>Doctor</li>
                        <li><Link to="/LandingDept">Department</Link></li>
